<?php
    ...
    if (isset($_POST['add_account'])) {
        ...
        if (!isset($_POST['name']) || empty($_POST['name'])) {
            // Si name_account está ausente o es nulo, manejar el error
            $failuredAcount = true;
            // Puedes redirigir o mostrar un mensaje de error aquí
        } else {
            // El campo name_account está presente y no es nulo, continuar con la lógica para agregar la cuenta
            $dataAccount = array(

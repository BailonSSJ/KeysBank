<div class="<?php echo $registered ? 'container-box' : 'hidden' ?>">
    ...
    <a href="<?php echo $_SERVER['PHP_SELF']; ?>"><button>Volver al inicio de sesión</button></a>
    </div>
</div>
...
<form action="index.php?register" method="POST" class="<?php echo $registered ? 'hidden' : 'form_login'; ?>">
    ...
    <div><a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="back-login">Volver al inicio de sesión</a></div>
</form>